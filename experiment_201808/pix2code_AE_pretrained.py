...
#
# - with AE_bootstrap as encoder (2 layer CNN)
...
class EncoderCNN(torch.nn.Module):
    ...
    def __init__(self, embed_size):
        ...
        self.feature = torch.nn.Sequential(
            ...
            torch.nn.BatchNorm1d(embed_size,momentum=0.01),
            )
...
def train(encoder, decoder, train_loader, test_loader, criterion, optimizer,
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch+1) % save_interval == 0:
            ...
            torch.save(optimizer, os.path.join("./Logs/{}/".format(time), "optimizer_epoch{}.pkl".format(epoch)) )
