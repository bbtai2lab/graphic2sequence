...
結論：結局pix2codeでは、Resnet18(free)の方が予測精度一番いいモデルです。pix2codeの中にCNN Encoderを一緒に学習させるのは大事でしょう。AEを使う方では、モデルがより単純に作られていますので、予め学習させたとは言え、Test LossはResnet18(free)と比べるとちょっと高い。（結論保留）
